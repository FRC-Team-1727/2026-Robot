...
public class FieldConstants {
    ...
    public static class Hub {
        ...
        public static final Translation2d nearLeftCorner = new Translation2d(topCenterPointBlue.getX() - width / 2.0,
                fieldWidth / 2.0 + width / 2.0);
        public static final Translation2d nearRightCorner = new Translation2d(topCenterPointBlue.getX() - width / 2.0,
                fieldWidth / 2.0 - width / 2.0);
        public static final Translation2d farLeftCorner = new Translation2d(topCenterPointBlue.getX() + width / 2.0,
                fieldWidth / 2.0 + width / 2.0);
        public static final Translation2d farRightCorner = new Translation2d(topCenterPointBlue.getX() + width / 2.0,
                fieldWidth / 2.0 - width / 2.0);
